...
function Footer({ userBtn, setUserBtn }) {
  ...
  return (
    <div className="w-full  fixed bottom-0 z-20 bg-white shadow-gray-500 shadow-md z-10">
      <div className=" flex justify-between pl-2 pr-2 lg:w-full lg:items-center">
        <div className="flex space-x-8 lg:w-[30%] lg:justify-between lg:items-center ">
          <a href="#" target="_blank" rel="noopener noreferrer">
            <img
              ...
              className="h-15 w-auto scale-[1] hover:scale-[1] cursor-pointer"
            />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer">
            <img
...
//               src="https://assets.mspimages.in/gear/wp-content/uploads/2023/09/make-in-india.jpg"
//               alt="Make in India"
//               className="h-20 w-auto scale-[1] hover:scale-[1] cursor-pointer"
//             />
//           </a>
//           <a href="#" target="_blank" rel="noopener noreferrer">
//             <img
